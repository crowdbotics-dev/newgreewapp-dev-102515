"""
Django settings for newgreewapp_dev_102515 project.
...
ROOT_URLCONF = 'newgreewapp_dev_102515.urls'
...
WSGI_APPLICATION = 'newgreewapp_dev_102515.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newgreewapp_dev_102515 API",
    "DESCRIPTION": "API documentation for newgreewapp_dev_102515 App",
    "VERSION": "v1",
}
